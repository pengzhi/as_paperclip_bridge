module ActiveScaffold::Config
  class Core < Base
    ...
    def configure_paperclip_field(field)
      self.columns << field
      has_attached_file_options = self.model.attachment_definitions[field]
      self.columns[field].list_ui ||= (has_attached_file_options and has_attached_file_options[:styles].try(:include?, :thumbnail)) ? :paperclip_thumb : :paperclip_link
